...
引用してコメントする回答は最大2つまでにしてください。「○○」の形で引用し、その回答についてコメントしてください。
冒頭に回答リストを羅列しないでください。いきなり講評から始めてください。
...
引用してコメントする回答は最大2つまでにしてください。「○○」の形で引用し、そのボケの構造や技術的な面白さについて分析してください。
冒頭に回答リストを羅列しないでください。いきなり講評から始めてください。
${buildBaseData(odaiTitle, kotaeList, 'あなたの回答')}`,
...
引用してコメントする回答は最大2つまでにしてください。「○○」の形で引用し、その回答の良い面や発想の素晴らしさについて優しくコメントしてください。
冒頭に回答リストを羅列しないでください。いきなり講評から始めてください。
${buildBaseData(odaiTitle, kotaeList, 'あなたの回答')}`,
