  ...
  const [matsumotoResponse, bakarismResponse, kawashimaResponse] = await Promise.all([
    ...
    openai.chat.completions.create({
      ...
      messages: [
        ...
        {
          role: 'user',
          content: `大喜利の結果について、松本人志らしい厳しく鋭い講評を100-150文字で作成してください。関西弁で、良いものは褒めて、ダメなものは厳しく指摘してください。
...
${baseData}`,
    ...
    openai.chat.completions.create({
      ...
      messages: [
        ...
        {
          role: 'user',
          content: `大喜利の結果について、バカリズムらしい論理的で技術的な講評を100-150文字で作成してください。ボケの構造やパターンを分析的に解説してください。
...
${baseData}`,
    ...
    openai.chat.completions.create({
      ...
      messages: [
        ...
        {
          role: 'user',
          content: `大喜利の結果について、麒麟川島らしい優しく温かい講評を100-150文字で作成してください。全ての回答の良い面を見つけて、励ましの言葉をかけてください。
