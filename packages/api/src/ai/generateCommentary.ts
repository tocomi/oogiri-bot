...
`
  ...
  // 3人分の講評を並行生成
  const [matsumotoResponse, bakarismResponse, kawashimaResponse] =
    await Promise.all([
      // 松本人志スタイル
      openai.chat.completions.create({
        ...
        messages: [
          ...
          {
            role: 'user',
            content: `大喜利の結果について、松本人志らしい厳しく鋭い講評を200文字程度で作成してください。関西弁で、良いものは褒めて、ダメなものは厳しく指摘してください。
...
${baseData}`,
      ...
      openai.chat.completions.create({
        ...
        messages: [
          ...
          {
            role: 'user',
            content: `大喜利の結果について、バカリズムらしい論理的で技術的な講評を200文字程度で作成してください。ボケの構造やパターンを分析的に解説してください。
...
${baseData}`,
      ...
      openai.chat.completions.create({
        ...
        messages: [
          ...
          {
            role: 'user',
            content: `大喜利の結果について、麒麟川島らしい優しく温かい講評を200文字程度で作成してください。全ての回答の良い面を見つけて、励ましの言葉をかけてください。
...
${baseData}`,
  ...
  return {
    matsumoto:
      matsumotoResponse.choices[0].message.content || 'あかん、講評でけへん。',
    bakarism:
